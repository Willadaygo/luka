...
},{"core-js/fn/regexp/escape":2,"core-js/shim":295,"regenerator-runtime/runtime":301}],2:[function(require,module,exports){
...
},{"./":297}],297:[function(require,module,exports){
...
},{"_process":300}],298:[function(require,module,exports){
/*!
...
_inView2.default.threshold(0.2); // set gloabl inView threshold

var aniTime = 250; // if you change here, make sure you change in ani.css 
var links = {
...
var reveal = function reveal() {
  (0, _inView2.default)('.js-reveal').on('enter', function (el) {
    return el.classList.add('in-view');
  });
};

var revealChild = function revealChild() {
  (0, _inView2.default)('.js-reveal').on('enter', function (el) {
    var children = el.querySelectorAll('.js-reveal__child');

    var _loop = function _loop(i) {
      var delay = aniTime + i * 50;
...
var revealChangePage = function revealChangePage(target) {
  var href = target.href;
  var direction = target.getAttribute('data-direction');
  var header = document.querySelector('.Header');
  var nav = document.querySelector('.Projects-nav');
  var elementsInView = Array.from(document.querySelectorAll('.js-reveal.in-view'));

  if (direction && direction === 'right') {
    for (var i = 0; i < elementsInView.length; i += 1) {
      nav.classList.add('js-reveal--pageOutRight');
      elementsInView[i].classList.add('js-reveal--pageOutRight');
    }
  } else if (direction && direction === 'left') {
    for (var _i = 0; _i < elementsInView.length; _i += 1) {
      nav.classList.add('js-reveal--pageOutLeft');
      elementsInView[_i].classList.add('js-reveal--pageOutLeft');
    }
  } else {
    for (var _i2 = 0; _i2 < elementsInView.length; _i2 += 1) {
      elementsInView[_i2].classList.add('js-reveal--pageOutDown');
    }
  }
...
var init = function init() {
  ...
  var internal = Array.from(links.internal);
  var computed = Array.from(links.computed);
  var allLinks = internal.concat(computed);
...
},{"in-view":298}],303:[function(require,module,exports){
'use strict';
...
var _ani = require('./ani');

var _ani2 = _interopRequireDefault(_ani);

var _jump = require('./utilities/jump');
...
_customEvents2.default.init();
_ani2.default.init();
_header2.default.init();
_jump2.default.init();

},{"../modules/header/header":307,"./ani":302,"./utilities/custom-events":304,"./utilities/jump":305,"babel-polyfill":1,"es6-promise/auto":296}],304:[function(require,module,exports){
'use strict';
...
var Listeners = {
  scroll: {
    throttled: (0, _throttle2.default)(function () {
...
},{"./throttle":306}],305:[function(require,module,exports){
'use strict';
...
var goToSection = function goToSection(link, delay, callback) {
  var section = document.querySelector('' + link);
  setTimeout(function () {
    (0, _jump2.default)(section, {
      duration: 500,
...
var getLinks = function getLinks(callback) {
...
var init = function init() {
  getLinks(function (link) {
    goToSection(link, 500, _header.closeHeader);
  });
};
...
},{"../../modules/header/header":307,"jump.js":299}],306:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
var timeNow = Date.now || new Date().getTime();
...
var openHeader = exports.openHeader = function openHeader() {
  _.header.classList.add('is-open');
  _.html.classList.add('has-nav');
};

var closeHeader = exports.closeHeader = function closeHeader() {
